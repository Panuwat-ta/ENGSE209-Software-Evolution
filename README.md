...
| **นาย เอกพันธ์ ทศทิศรังสรรค์** | 6754210044-3 | **QA / Tester**<br>- ออกแบบกรณีการทดสอบ (Test Cases) ครอบคลุมการทำงานทั่วไปและเคสขอบเขตที่เป็นอันตราย (Edge Cases)<br>- จัดทำเอกสารชุดทดสอบและทำ Automated Unit Testing เพื่อยืนยันคุณภาพของระบบ |
| **นาย ณฐภาพ สายหล้า** | 6754210044-3 | **Tech Lead / Architect**<br>- ออกแบบแนวทางการปรับโครงสร้างโค้ด (Refactoring Architecture)<br>- ตรวจสอบคุณภาพของโค้ด (Code Review) และกำหนดแนวทางเขียนโค้ดที่ถูกต้องตามมาตรฐาน (PEP 8) |
...
│   └── trello.md                 # รายการงานและตารางคุมงานช่วงสัปดาห์ที่ 1 (test)
