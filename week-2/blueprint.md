...
**ระบบจัดการคลังสินค้า (Inventory Management System v2.0)**

เอกสารฉบับนี้เป็นแผนพิมพ์เขียว (Blueprint) ที่วิเคราะห์โครงสร้างของโค้ดเดิมใน `app_v1.py` ซึ่งยังขาดความเป็นระเบียบและสถาปัตยกรรมที่ดี เพื่อเตรียมการปรับปรุงโครงสร้าง (Refactoring) ไปสู่การพัฒนาที่ยั่งยืนและมีประสิทธิภาพยิ่งขึ้น (Software Evolution)
